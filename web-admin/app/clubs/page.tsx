...
export default function ClubsPage() {
  ...
  const filteredClubs = useMemo(() => {
    ...
    return clubs.filter((club) => {
      const searchable = [club.name, club.handle, club.bio, ...club.tags]
        .join(" ")
        .toLowerCase();
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <h1 className="mt-1 text-3xl font-bold tracking-tight">Kulüpler</h1>
        <p className="mt-2 max-w-2xl text-sm text-text2">
          Kampüs kulüplerini keşfet, etkinliklerine ve paylaşımlarına göz at.
        </p>
      </div>
